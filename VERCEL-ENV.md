# Miljøvariabler til Vercel (portal.smartrep.nu / ordrebekræftelse)
...
| `NEXT_PUBLIC_BASE_URL` | **https://portal.smartrep.nu** (eller jeres Vercel-URL indtil domæne er sat) |
| `PORTAL_PUBLIC_URL` | **https://portal.smartrep.nu** (eller jeres Vercel-URL) – bruges i link i SMS/email |
| `CORS_ORIGINS` | `*` |
...
**Domæne:** Under **Settings → Domains** kan I tilføje `portal.smartrep.nu` og pege det på dette projekt (Vercel guider dig).
